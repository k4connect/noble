...
Noble.prototype.registerPasskeyProvider = function(passkeyProvider) {
  if(this._bindings.registerPasskeyProvider) {
    this._bindings.registerPasskeyProvider(passkeyProvider);
  } else {
    throw new Error("Passkey provider not supported on this platform");
  }
}
